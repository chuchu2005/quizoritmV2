...
const LoadingQuestions = ({ finished }: Props) => {
  ...
  return (
    <div className="absolute inset-0 mt-24 -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-[70vw] md:w-[60vw] flex flex-col items-center">
      <Image src={"/loading.gif"} width={400} height={400} alt="loading" />
      <div className="w-full mt-4" ><Progress value={progress} /></div>
